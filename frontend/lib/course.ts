...
const KAZAKH_MISSION_COPY: Record<string, MissionTranslation> = {
  "build-simple": {
    title: "1-миссия — Қарапайымнан бастаңыз",
    shortTitle: "Қарапайымнан бастаңыз",
    description: "Lovable платформасын ашып, қарапайым жұмыс істейтін жоба жасаңыз.",
    brief: "Идеяны күрделендірмеңіз. Мақсат — жұмыс істейтін нәтиже жасап, жобаны тез іске қосуға үйрену.",
    homework: "Lovable платформасында бір қарапайым жұмыс істейтін бет немесе қолданба жасаңыз. Ол шағын жеке мәселені шешуі немесе бір пайдалы функцияны көрсетуі мүмкін. Жобаны жариялап, сілтемесі бар кез келген адам аша алатын Lovable сілтемесін жіберіңіз.",
    rubric: [
      "Жоба Lovable платформасында жасалған.",
      "Сілтеме жарияланған бетті немесе қолданбаны ашады.",
      "Жобада көрінетін бет немесе пайдалы функция бар.",
      "Оқытушы жобаны рұқсат сұрамай аша алады.",
    ],
    artifact: "Lovable сілтемесі",
    videos: [{ title: "Vibe Coding дегеніміз не? ТЗ құру. Lovable арқылы сайт жасау", youtubeId: "9DNBmqXVUfs" }],
    submissionFields: [{ key: "lovable_url", label: "Lovable сілтемесі", type: "url", required: true, placeholder: "https://..." }],
  },
  "build-vibe-coding": {
    title: "2-миссия — Вайб-кодингті үйреніңіз",
    shortTitle: "Вайб-кодингті үйреніңіз",
    description: "Вайб-кодингпен танысып, жаңа сайт жасаңыз немесе алғашқы миссиядағы жобаңызды жақсартыңыз.",
    brief: "Replit, Lovable немесе Bolt сияқты кез келген no-code не AI-кодинг құралын пайдаланыңыз.",
    homework: "Replit, Lovable немесе Bolt арқылы жаңа сайт жасаңыз немесе алғашқы жобаңызды едәуір жақсартыңыз. Кемінде бір пайдалы функцияны, контент бөлімін немесе дизайн элементін қосып не жетілдіріп, нәтижені жариялаңыз және жұмыс істейтін сайт сілтемесін жіберіңіз.",
    rubric: [
      "Нәтиже — жаңа сайт немесе бірінші миссиядағы жобаның елеулі жақсартылған нұсқасы.",
      "Сайт AI немесе no-code құралы арқылы жасалған.",
      "Кемінде бір пайдалы функция, контент бөлімі немесе дизайн элементі қосылған не жақсартылған.",
      "Жіберілген сілтеме жұмыс істейтін сайтты ашады.",
    ],
    artifact: "Сайт сілтемесі",
    videos: [{ title: "Вайб кодинг: жоба жасау", youtubeId: "83GGUVNbrVI" }],
    submissionFields: [{ key: "website_url", label: "Сайт сілтемесі", type: "url", required: true, placeholder: "https://..." }],
  },
  "build-real-vibe-coding": {
    title: "3-миссия — Нағыз вайб-кодингті қолданып көріңіз",
    shortTitle: "Нағыз вайб-кодинг",
    description: "AI-кодинг құралымен жұмыс істеп, коды бар GitHub репозиторийін жіберіңіз.",
    brief: "Барлық құралды үйренудің қажеті жоқ. Claude Code, Cursor немесе Codex құралдарының бірін таңдаңыз.",
    homework: "Claude Code, Cursor немесе Codex құралдарының бірін таңдап, шағын жұмыс істейтін жоба жасаңыз. Жоба файлдарын GitHub-қа жүктеп, репозиторий сілтемесін жіберіңіз. Репозиторийде код барын және оқытушы оны аша алатынын тексеріңіз.",
    rubric: [
      "Жобаны жасау үшін Claude Code, Cursor немесе Codex қолданылған.",
      "GitHub репозиторийінде жобаның бастапқы коды бар.",
      "Репозиторий бос емес, жұмыс істейтін нәтиже ұсынады.",
      "Оқытушы репозиторийді аша алады.",
    ],
    artifact: "Коды бар GitHub сілтемесі",
    videos: [{ title: "AI арқылы код жазбай стартап жасау: Vibe Coding, Claude Code", youtubeId: "Xhn2vnXM6fI" }],
    submissionFields: [{ key: "github_url", label: "Коды бар GitHub сілтемесі", type: "url", required: true, placeholder: "https://github.com/..." }],
  },
  "discover-find-problem": {
    title: "4-миссия — Мәселені табыңыз",
    shortTitle: "Мәселені табыңыз",
    description: "Айналаңыздағы нақты мәселелерді тауып, әрқайсысына ықтимал шешім ұсыныңыз.",
    brief: "Бизнестің негізгі міндеті — адамдардың мәселесін шешіп, құндылық жасау.",
    homework: "Өзіңіз немесе айналаңыздағы адамдар кездесетін бес нақты мәселені жазыңыз. Әр мәселе үшін кімнің, қашан немесе қай жерде кездесетінін және бір ықтимал шешімді көрсетіңіз. Бес нөмірленген «мәселе — шешім» жұбын жіберіңіз.",
    rubric: [
      "Бес түрлі нақты мәселе көрсетілген.",
      "Әр мәселе кімде кездесетіні жазылған.",
      "Әр мәселе қашан немесе қай жерде туындайтыны түсіндірілген.",
      "Әр мәселеге бір ықтимал шешім ұсынылған.",
    ],
    artifact: "5 нақты мәселе және 5 шешім",
    videos: [{ title: "ЖИ көмегімен стартап немесе IT-жобаға идея табу", youtubeId: "1IU8a3NGP5Q" }],
    submissionFields: [{ key: "problems_and_solutions", label: "Мәселелер мен шешімдер", type: "textarea", required: true, placeholder: "5 нақты мәселе мен оларды шешудің 5 жолын жазыңыз." }],
  },
  "discover-talk-to-people": {
    title: "5-миссия — Адамдармен сөйлесіңіз",
    shortTitle: "Адамдармен сөйлесіңіз",
    description: "Ықтимал пайдаланушылармен сөйлесіп, олардың нақты тәжірибесінен үйреніңіз.",
    brief: "Шешіміңізді сатуға тырыспай, адамның не істейтінін, не қиналтатынын және бұрын не болғанын сұраңыз.",
    homework: "Тапқан мәселелеріңіздің бірі туралы ықтимал пайдаланушылармен сөйлесіңіз. Шешіміңізді таныстырмай, олардың бұрынғы нақты тәжірибесін сұраңыз. Кіммен сөйлескеніңізді және не білгеніңізді көрсететін бес түрлі қорытынды жіберіңіз.",
    rubric: [
      "Қорытындылар ықтимал пайдаланушылармен болған әңгімелерге негізделген.",
      "Бес түрлі қорытынды берілген.",
      "Әр қорытындыда сұхбаттасушы немесе клиент сегменті көрсетілген.",
      "Әр қорытынды әңгімеден алынған нақты білімді сипаттайды.",
    ],
    artifact: "Клиенттермен сөйлесуден алынған 5 қорытынды",
    videos: [{ title: "Стартап құру жолы: қиындықтар, қателіктер және тәжірибе", youtubeId: "ET5oX9gxGTk" }],
    submissionFields: [{ key: "conversation_insights", label: "Сұхбаттан алынған қорытындылар", type: "textarea", required: true, placeholder: "Кіммен сөйлескеніңізді және не білгеніңізді көрсететін 5 қорытынды жазыңыз." }],
  },
  "discover-evaluate-ideas": {
    title: "6-миссия — Стартап идеяларын тауып, бағалаңыз",
    shortTitle: "Идеяларды тауып, бағалаңыз",
    description: "Табылған мәселелер мен сұхбаттарды тексеруге болатын стартап идеяларына айналдырыңыз.",
    brief: "Нақты мәселеге байланысты, өршіл әрі түсінікті идеяларды таңдаңыз.",
    homework: "Тапқан мәселелеріңіз бен сұхбат қорытындыларын бес стартап идеясына айналдырыңыз. Әр идея үшін мақсатты клиентті, мәселені және ұсынылатын шешімді көрсетіңіз. Идеяларды нөмірленген тізіммен, тексеруге жеткілікті нақты түрде жіберіңіз.",
    rubric: [
      "Бес түрлі стартап идеясы берілген.",
      "Әр идеяның мақсатты клиенті анықталған.",
      "Әр идея нақты мәселені шешеді.",
      "Әр идея үшін тексеруге болатын шешім ұсынылған.",
    ],
    artifact: "5 өршіл стартап идеясы",
    videos: [{ title: "Бір тиын жұмсамай бизнес идеяны тексеру", youtubeId: "JRpY6KmMeYk" }],
    submissionFields: [{ key: "startup_ideas", label: "Стартап идеялары", type: "textarea", required: true, placeholder: "Ең өршіл 5 стартап идеяңызды жазыңыз." }],
  },
  "launch-build-mvp": {
    title: "7-миссия — MVP жасаңыз",
    shortTitle: "MVP жасаңыз",
    description: "Өнім гипотезасын тексеретін минималды өміршең өнім жасаңыз.",
    brief: "MVP — гипотезаны тексеруге жеткілікті ең шағын пайдалы өнім.",
    homework: "Бір негізгі өнім гипотезасын таңдап, оны тексеретін минималды жұмыс істейтін нұсқаны жасаңыз. Негізгі пайдаланушы сценарийін іске асырып, MVP-ді жариялаңыз және оқытушы аша алатын сілтемені жіберіңіз.",
    rubric: [
      "MVP бір нақты өнім гипотезасын тексереді.",
      "Негізгі пайдаланушы сценарийі жұмыс істейді.",
      "Жіберілген сілтеме MVP-дің өзін ашады.",
      "Оқытушы өнімді рұқсат сұрамай аша алады.",
    ],
    artifact: "MVP сілтемесі",
    videos: [{ title: "Вайбкодингпен интерактивті сайт жасау", youtubeId: "c0BlOicNoy0" }],
    submissionFields: [{ key: "mvp_url", label: "MVP сілтемесі", type: "url", required: true, placeholder: "https://..." }],
  },
  "launch-product-online": {
    title: "8-миссия — Өнімді онлайн іске қосыңыз",
    shortTitle: "Өнімді онлайн іске қосыңыз",
    description: "Өніміңіз туралы интернетте жариялап, оны аудиторияға таныстырыңыз.",
    brief: "Instagram, Threads немесе LinkedIn желісінде өнім туралы 10 жазба жариялаңыз.",
    homework: "Instagram, Threads, LinkedIn немесе бірнеше желіде өнім туралы 10 жазба жариялаңыз. Мәселе, өнім, жұмыс барысы немесе алған сабағыңыз туралы айтыңыз. Ашық жарияланымдарды көруге болатын барлық аккаунт сілтемелерін қосыңыз.",
    rubric: [
      "Өнім туралы он ашық жазба жарияланған.",
      "Жазбалар мәселе, өнім, жұмыс барысы немесе алынған сабақтар туралы.",
      "Жазбалар жарияланған барлық аккаунттар көрсетілген.",
      "Оқытушы жарияланымдарды рұқсат сұрамай аша алады.",
    ],
    artifact: "Әлеуметтік желідегі аккаунт сілтемелері",
    videos: [{ title: "SMM деген не және клиентті қалай табамыз?", youtubeId: "cuuuhuH9fV8" }],
    submissionFields: [{ key: "social_account_links", label: "Әлеуметтік желідегі аккаунт сілтемелері", type: "link_list", required: true, placeholder: "https://..." }],
  },
  "launch-first-customers": {
    title: "9-миссия — Алғашқы клиенттерді табыңыз",
    shortTitle: "Алғашқы клиенттерді табыңыз",
    description: "Кімге сататыныңызды және алғашқы клиенттерге қалай жететініңізді сипаттаңыз.",
    brief: "Клиенттеріңізді, оларды қайдан табатыныңызды және сатудың алғашқы қадамдарын нақты жазыңыз.",
    homework: "Алғашқы клиенттердің бір нақты сегментін, оларды қайдан табуға болатынын және қандай ұсыныс жасайтыныңызды анықтаңыз. Содан кейін әрқайсысының арнасы мен хабарламасын көрсетіп, сатудың алғашқы үш әрекетін сипаттаңыз.",
    rubric: [
      "Алғашқы клиенттердің бір нақты сегменті анықталған.",
      "Бұл клиенттерді қайдан табуға болатыны көрсетілген.",
      "Клиенттерге арналған ұсыныс сипатталған.",
      "Әрқайсысының арнасы мен хабарламасы бар үш сату әрекеті берілген.",
    ],
    artifact: "Клиенттерді табу және сату жоспары",
    videos: [{ title: "Кәсіпкерге табыс әкелетін сатудағы тәсілдер", youtubeId: "SXRtYGpVI1U" }],
    submissionFields: [{ key: "customer_plan", label: "Клиенттерді табу және сату жоспары", type: "textarea", required: true, placeholder: "Клиенттеріңізді, арналарды және сатудың алғашқы қадамдарын сипаттаңыз." }],
  },
};
...
export const KAZAKH_COURSE_MISSIONS: CourseMission[] = COURSE_MISSIONS.map((mission) => ({
  ...mission,
  ...KAZAKH_MISSION_COPY[mission.slug],
  slug: `kk-${mission.slug}`,
  resources: mission.resources.map((resource) => ({ ...resource, label: "Lovable шақыру сілтемесі" })),
}));

const KAZAKH_SECTION_COPY: Record<CourseSectionId, Pick<CourseSection, "title" | "description">> = {
  build: { title: "Жасау", description: "AI көмегімен алғашқы өнімдеріңізді жасап, жұмыс істейтін сілтемелерді жариялаңыз." },
  discover: { title: "Зерттеу", description: "Клиенттерді зерттеп, мәселелерді нақтылап, мықты стартап идеяларын табыңыз." },
  launch: { title: "Іске қосу", description: "Өнімді нақты пайдаланушыларға көрсетіп, алғашқы кері байланысты алыңыз." },
  scale: { title: "Өсу", description: "Іске қосқаннан кейін ұстап қалуды, өсу арналарын және монетизацияны жақсартыңыз." },
};

export const KAZAKH_COURSE_SECTIONS: CourseSection[] = COURSE_SECTIONS.map((section) => ({
  ...section,
  ...KAZAKH_SECTION_COPY[section.id],
  missionSlugs: section.missionSlugs.map((slug) => `kk-${slug}`),
}));
...
export const COURSES: Course[] = [
  ...
  {
    id: "kk",
    name: "Қазақ тіліндегі курс",
    description: "Тоғыз практикалық миссия арқылы AI-өнім жасап, тексеріп, іске қосыңыз.",
    missions: KAZAKH_COURSE_MISSIONS,
    sections: KAZAKH_COURSE_SECTIONS,
  },
];
